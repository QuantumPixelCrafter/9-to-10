export type LevelGroup = "primary" | "secondary" | "university";
...
export const LEVEL_GROUP_INFO: Record<LevelGroup, {
  ...
  primary: {
    label: "Primary School", short: "Primary", emoji: "🌱",
    gradient: "from-green-400 to-emerald-500",
    description: "Foundation learning for ages 7–12. Covers core subjects to build strong fundamentals.",
    levels: ["P1","P2","P3","P4","P5","P6"],
    levelDesc: "P1 = Primary 1 (age 7) up to P6 = Primary 6 (age 12)",
  },
  secondary: {
    label: "Secondary School", short: "Secondary", emoji: "📘",
    gradient: "from-blue-500 to-indigo-600",
    description: "Intermediate education for ages 13–18. Deeper subject knowledge and exam preparation.",
    levels: ["S1","S2","S3","S4","S5","S6"],
    levelDesc: "S1 = Secondary 1 (age 13) up to S6 = Pre-University (age 18)",
  },
  university: {
...
const CURRICULUM: Record<LevelGroup, QuizSubject[]> = {
  primary: [
    ...
    {
      id: "chinese", name: "Chinese Language", icon: "🀄", color: "from-red-400 to-rose-500",
      topics: [
        { id: "characters", name: "Vocabulary & Characters", description: "Chinese characters, radicals and word recognition" },
        { id: "grammar-cn", name: "Grammar & Sentence Structure", description: "Sentence patterns and correct usage in Chinese" },
        { id: "reading-cn", name: "Reading Comprehension", description: "Understanding Chinese passages and answering questions" },
        { id: "composition-cn", name: "Composition Writing", description: "Writing Chinese essays and narratives" },
        { id: "listening-cn", name: "Listening & Oral Skills", description: "Oral communication and listening comprehension" },
      ],
    },
    {
      id: "malay", name: "Malay Language", icon: "🌴", color: "from-green-500 to-lime-500",
      topics: [
        { id: "vocab-ms", name: "Vocabulary & Word Study", description: "Malay vocabulary, affixes and word families" },
        { id: "grammar-ms", name: "Grammar & Language Use", description: "Sentence structure and grammar rules in Bahasa Melayu" },
        { id: "reading-ms", name: "Reading & Comprehension", description: "Reading Malay passages and answering questions" },
        { id: "composition-ms", name: "Composition Writing", description: "Writing essays and stories in Malay" },
        { id: "oral-ms", name: "Oral Communication", description: "Speaking and listening skills in Bahasa Melayu" },
      ],
    },
  ],
  secondary: [
