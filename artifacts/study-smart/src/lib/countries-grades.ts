...
const IB_GRADES: Grade[] = [
  ...primary(["PYP1","PYP2","PYP3","PYP4","PYP5","PYP6"], ["PYP Year 1","PYP Year 2","PYP Year 3","PYP Year 4","PYP Year 5","PYP Year 6"]),
  ...secondary(["MYP1","MYP2","MYP3","MYP4","MYP5","DP1","DP2"], ["MYP Year 1","MYP Year 2","MYP Year 3","MYP Year 4","MYP Year 5","DP Year 1","DP Year 2"]),
  ...university(["U1","U2","U3","U4"], ["University Year 1","University Year 2","University Year 3","University Year 4"]),
];
...
export const COUNTRIES: CountryDef[] = [
  ...
  { code: "IB", name: "International / IB School", flag: "🌐", schoolYearStartMonth: 9, grades: IB_GRADES },
];
